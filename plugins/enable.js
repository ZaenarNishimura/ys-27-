...
const listMessage = {
  text: '\nBerikut adalah daftar yang dapat Anda aktifkan dan nonaktifkan',
  footer: fgig,
  title: `≡ Daftar Opsi`,
...
m.reply(`
✅ *${type}* Dengan *${isEnable ? 'Aktif' : 'dinonaktifkan'}* ${isAll ? 'adalah bot' : isUser ? '' : 'adalah obrolan'}
`.trim()) 

}
handler.help = ['di dalam', 'dis'].map(v => v + 'mampu <option>')
handler.tags = ['nable']
